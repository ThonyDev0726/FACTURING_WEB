...
public class AgregarDetalle extends HttpServlet {
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        FK_PRODUCTO_STRING = ((String) json.get("txtIdProd"));// DATO DEL JSON
        FK_PRODUCTO = Integer.parseInt(FK_PRODUCTO_STRING);// DATO DEL JSON
//        FK_PRODUCTO = 1;// DATO DEL JSON
        DET_CANTIDAD_STRING = ((String) json.get("txtProCantidad"));// DATO DEL JSON
        DET_CANTIDAD = Integer.parseInt(DET_CANTIDAD_STRING);// DATO DEL JSON
//        DET_CANTIDAD = 5;// DATO DEL JSON
        DET_TOTAL_STRING = ((String) json.get("txtProTotal"));// DATO DEL JSON
...
//        DET_TOTAL = 10.0;// DATO DEL JSON
        ...
        if (usu == null) {
            ...
            if (PRO_STOCK > DET_CANTIDAD) {
                ...
                daoDet.add(det);
                dao.actualizarStock(FK_PRODUCTO, PRO_STOCK - DET_CANTIDAD);
