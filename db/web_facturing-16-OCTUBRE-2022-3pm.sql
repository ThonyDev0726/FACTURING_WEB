...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2022 a las 19:07:59
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `A_SELECT_ALL_CALCULOS_FINALES` ()   BEGIN 
	SELECT
    ID_CALCULO,
    IDENTIFICACION_COMPROBANTE.ID_COMPROBANTE,
	CAL_SUBTOTAL,
	CAL_SUBTOTAL_CERO,
	CAL_SUBTOTAL_NO_OBJ_IVA,
	CAL_SUBTOTAL_EXC_IVA,
	CAL_SUBTOTAL_SIN_IMPUESTOS,
    CAL_TOTAL_DESC,
    CAL_ICE,
    CAL_IVA_12,
    CAL_DEVOLUCION_IVA,
    ...
    INNER JOIN IDENTIFICACION_COMPROBANTE ON CALCULOS_FINALES.FK_IDENTIFICACION_COMPROBANTE = IDENTIFICACION_COMPROBANTE.ID_COMPROBANTE;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `A_SELECT_ALL_DATOS_EMISOR` ()   BEGIN 
	SELECT
    ID_EMPRESA,
    SUCURSAL.SUC_NOMBRE,
	EMP_RUC,
	...
	EMP_RAZON_SOCIAL,
	EMP_CONTRIBUYENTE_ESP,
	EMP_MATRIZ
	FROM DATOS_EMISOR 
    INNER JOIN SUCURSAL ON DATOS_EMISOR.FK_SUCURSAL = SUCURSAL.ID_SUCURSAL;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `A_SELECT_ALL_DETALLE_FACTURA` ()   BEGIN 
	SELECT
    ID_DETALLE,
    IDENTIFICACION_COMPROBANTE.ID_COMPROBANTE,
	DET_COD_PRINCIPAL,
    ...
    INNER JOIN IDENTIFICACION_COMPROBANTE ON DETALLE_FACTURA.FK_COMPROBANTE = IDENTIFICACION_COMPROBANTE.ID_COMPROBANTE;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `A_SELECT_ALL_IDENTIFICACION_COMPROBANTE` ()   BEGIN 
	SELECT
    ID_COMPROBANTE,
    FK_CLIENTE,
    CON_NUMERO,
	...
	CON_CLAVE_ACCESO,
	CON_GUIA_EMISION	
	FROM IDENTIFICACION_COMPROBANTE;
    END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETE_CALCULOS_FINALES` (IN `ID_CALCULO_V` INT)   BEGIN 
	DELETE FROM CALCULOS_FINALES WHERE ID_CALCULO = ID_CALCULO_V;
	END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETE_DATOS_EMISOR` (IN `ID_EMPRESA_V` INT)   BEGIN 
	DELETE FROM DATOS_EMISOR WHERE ID_EMPRESA = ID_EMPRESA_V;
	END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETE_DETALLE_FACTURA` (IN `ID_DETALLE _V` INT)   BEGIN 
	DELETE FROM DETALLE_FACTURA  WHERE ID_DETALLE = ID_DETALLE_V;
	END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETE_IDENTIFICACION_COMPROBANTE` (IN `ID_COMPROBANTE _V` INT)   BEGIN
    DELETE FROM IDENTIFICACION_COMPROBANTE WHERE ID_COMPROBANTE  = ID_COMPROBANTE_V;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_CALCULOS_FINALES` (IN `FK_IDENTIFICACION_COMPROBANTE_V` INT, IN `CAL_SUBTOTAL_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_CERO_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_NO_OBJ_IVA_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_EXC_IVA_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_SIN_IMPUESTOS_V` DECIMAL(10,3), IN `CAL_TOTAL_DESC_V` DECIMAL(10,3), IN `CAL_ICE_V` DECIMAL(10,3), IN `CAL_IVA_12_V` DECIMAL(10,3), IN `CAL_DEVOLUCION_IVA_V` DECIMAL(10,3), IN `CAL_IRBPNR_V` DECIMAL(10,3), IN `CAL_PROPINA_V` DECIMAL(10,3), IN `CAL_TOTAL_V` DECIMAL(10,3), IN `CAL_SIN_SUBCIDIO_V` DECIMAL(10,3), IN `CAL_AHORRO_SUBCIDIO_V` DECIMAL(10,3))   BEGIN
    INSERT INTO CALCULOS_FINALES (
        FK_IDENTIFICACION_COMPROBANTE,
        CAL_SUBTOTAL,
        CAL_SUBTOTAL_CERO,
        CAL_SUBTOTAL_NO_OBJ_IVA,
        CAL_SUBTOTAL_EXC_IVA,
        ...
        FK_IDENTIFICACION_COMPROBANTE_V,
        CAL_SUBTOTAL_V,
        CAL_SUBTOTAL_CERO_V,
        CAL_SUBTOTAL_NO_OBJ_IVA_V,
        CAL_SUBTOTAL_EXC_IVA_V,
        CAL_SUBTOTAL_SIN_IMPUESTOS_V,
        CAL_TOTAL_DESC_V,
        CAL_ICE_V,
        CAL_IVA_12_V,
        CAL_DEVOLUCION_IVA_V,
        CAL_IRBPNR_V,
        CAL_PROPINA_V,
        CAL_TOTAL_V,
        CAL_SIN_SUBCIDIO_V,
        CAL_AHORRO_SUBCIDIO_V
    );
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_DATOS_EMISOR` (IN `EMP_RUC_V` INT, IN `EMP_NOMBRE_COMERCIAL_V` VARCHAR(1000), IN `EMP_RAZON_SOCIAL_V` VARCHAR(255), IN `EMP_CONTRIBUYENTE_ESP_V` VARCHAR(15), IN `EMP_MATRIZ_V` VARCHAR(750), IN `FK_SUCURSAL_V` INT)   BEGIN
    INSERT INTO DATOS_EMISOR (
        EMP_RUC,
        EMP_NOMBRE_COMERCIAL,
        EMP_RAZON_SOCIAL,
        EMP_CONTRIBUYENTE_ESP,
        ...
        EMP_RUC_V,
        EMP_NOMBRE_COMERCIAL_V,
        EMP_RAZON_SOCIAL_V,
        EMP_CONTRIBUYENTE_ESP_V,
        EMP_MATRIZ_V,
        FK_SUCURSAL_V
    );
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_DETALLE_FACTURA` (IN `FK_COMPROBANTE_V` INT, IN `DET_COD_PRINCIPAL_V` VARCHAR(45), IN `DET_COD_AUX_V` VARCHAR(45), IN `DET_DESCRIPCION_V` VARCHAR(155), IN `DET_ADICIONAL_V` INT, IN `DET_PRECIO_UNITARIO_V` DECIMAL(10.3), IN `DET_PRECIO_TOTAL_V` DECIMAL(10.3))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_IDENTIFICACION_COMPROBANTE` (IN `FK_CLIENTE_V` INT, IN `CON_NUMERO_V` VARCHAR(50), IN `CON_FECHA_EMISION_V` DATE, IN `CON_CLAVE_ACCESO_V` VARCHAR(50), IN `CON_GUIA_EMISION_V` VARCHAR(30))   BEGIN 
	INSERT INTO IDENTIFICACION_COMPROBANTE (
        FK_CLIENTE,
        CON_NUMERO,
        CON_FECHA_EMISION,
        CON_CLAVE_ACCESO,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_CALCULOS_FINALES` ()   BEGIN
	SELECT * FROM CALCULOS_FINALES;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_DATOS_CLIENTE` ()   BEGIN
	SELECT * FROM CLIENTE;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_DATOS_EMISOR` ()   BEGIN
	SELECT * FROM DATOS_EMISOR;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_DATOS_EMPRESA` ()   BEGIN
	SELECT * FROM DATOS_EMISOR;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_DETALLE_FACTURA` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_IDENTIFICACION_COMPROBANTE` ()   BEGIN
	SELECT * FROM IDENTIFICACION_COMPROBANTE;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_CALCULOS_FINALES` (IN `ID_CALCULO_V` INT, IN `FK_IDENTIFICACION_COMPROBANTE_V` INT, IN `CAL_SUBTOTAL_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_CERO_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_NO_OBJ_IVA_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_EXC_IVA_V` DECIMAL(10,3), IN `CAL_SUBTOTAL_SIN_IMPUESTOS_V` DECIMAL(10,3), IN `CAL_TOTAL_DESC_V` DECIMAL(10,3), IN `CAL_ICE_V` DECIMAL(10,3), IN `CAL_IVA_12_V` DECIMAL(10,3), IN `CAL_DEVOLUCION_IVA_V` DECIMAL(10,3), IN `CAL_IRBPNR_V` DECIMAL(10,3), IN `CAL_PROPINA_V` DECIMAL(10,3), IN `CAL_TOTAL_V` DECIMAL(10,3), IN `CAL_SIN_SUBCIDIO_V` DECIMAL(10,3), IN `CAL_AHORRO_SUBCIDIO_V` DECIMAL(10,3))   BEGIN 
	UPDATE CALCULOS_FINALES SET
    	ID_CALCULO = ID_CALCULO_V,
        FK_IDENTIFICACION_COMPROBANTE = FK_IDENTIFICACION_COMPROBANTE_V,
        CAL_SUBTOTAL = CAL_SUBTOTAL_V,
        CAL_SUBTOTAL_CERO = CAL_SUBTOTAL_CERO_V,
        CAL_SUBTOTAL_NO_OBJ_IVA = CAL_SUBTOTAL_NO_OBJ_IVA_V,
        CAL_SUBTOTAL_EXC_IVA = CAL_SUBTOTAL_EXC_IVA_V,
        CAL_SUBTOTAL_SIN_IMPUESTOS = CAL_SUBTOTAL_SIN_IMPUESTOS_V,
        CAL_TOTAL_DESC = CAL_TOTAL_DESC_V,
        CAL_ICE = CAL_ICE_V,
        CAL_IVA_12 = CAL_IVA_12_V,
        CAL_DEVOLUCION_IVA = CAL_DEVOLUCION_IVA_V,
        CAL_IRBPNR = CAL_IRBPNR_V,
        CAL_PROPINA = CAL_PROPINA_V,
        CAL_TOTAL = CAL_TOTAL_V,
        CAL_SIN_SUBCIDIO = CAL_SIN_SUBCIDIO_V,
        CAL_AHORRO_SUBCIDIO = CAL_AHORRO_SUBCIDIO_V
    WHERE ID_CALCULO = ID_CALCULO_V;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_DATOS_EMISOR` (IN `ID_EMPRESA_V` INT, IN `EMP_RUC_V` INT, IN `EMP_NOMBRE_COMERCIAL_V` VARCHAR(1000), IN `EMP_RAZON_SOCIAL_V` VARCHAR(255), IN `EMP_CONTRIBUYENTE_ESP_V` VARCHAR(15), IN `EMP_MATRIZ_V` VARCHAR(750), IN `FK_SUCURSAL_V` INT)   BEGIN 
	UPDATE DATOS_EMISOR SET
    	ID_EMPRESA = ID_EMPRESA_V,
        EMP_RUC = EMP_RUC_V,
        EMP_NOMBRE_COMERCIAL = EMP_NOMBRE_COMERCIAL_V,
        EMP_RAZON_SOCIAL = EMP_RAZON_SOCIAL_V,
        EMP_CONTRIBUYENTE_ESP = EMP_CONTRIBUYENTE_ESP_V,
        EMP_MATRIZ = EMP_MATRIZ_V,
        FK_SUCURSAL = FK_SUCURSAL_V        
    WHERE ID_EMPRESA = ID_EMPRESA_V;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_DETALLE_FACTURA` (IN `ID_DETALLE_V` INT, IN `FK_COMPROBANTE_V` INT, IN `DET_COD_PRINCIPAL_V` VARCHAR(45), IN `DET_COD_AUX_V` VARCHAR(45), IN `DET_DESCRIPCION_V` VARCHAR(155), IN `DET_ADICIONAL_V` INT, IN `DET_PRECIO_UNITARIO_V` DECIMAL(10,3), IN `DET_PRECIO_TOTAL_V` DECIMAL(10,3))   BEGIN 
	UPDATE DETALLE_FACTURA SET
        FK_COMPROBANTE = FK_COMPROBANTE_V,
        DET_COD_PRINCIPAL = DET_COD_PRINCIPAL_V,
        DET_COD_AUX = DET_COD_AUX_V,
        DET_DESCRIPCION = DET_DESCRIPCION_V,
        DET_ADICIONAL = DET_ADICIONAL_V,
        DET_PRECIO_UNITARIO = DET_PRECIO_UNITARIO_V,
        DET_PRECIO_TOTAL = DET_PRECIO_TOTAL_V
    WHERE ID_DETALLE = ID_DETALLE_V;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_IDENTIFICACION_COMPROBANTE` (IN `ID_COMPROBANTE_V` INT(11), IN `FK_CLIENTE_V` INT, IN `CON_NUMERO_V` VARCHAR(50), IN `CON_FECHA_EMISION_V` DATE, IN `CON_CLAVE_ACCESO_V` VARCHAR(50), IN `CON_GUIA_EMISION_V` VARCHAR(30))   BEGIN
	UPDATE IDENTIFICACION_COMPROBANTE SET 
    FK_CLIENTE=FK_CLIENTE_V,
    CON_NUMERO=CON_NUMERO_V ,
    CON_FECHA_EMISION = CON_FECHA_EMISION_V,
    CON_CLAVE_ACCESO=CON_CLAVE_ACCESO_V,
    CON_GUIA_EMISION=CON_GUIA_EMISION_V  
    WHERE ID_COMPROBANTE = ID_COMPROBANTE_V;
END$$
...
CREATE TABLE `calculos_finales` (
  ...
  `FK_IDENTIFICACION_COMPROBANTE` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `calculos_finales`
--

INSERT INTO `calculos_finales` (`ID_CALCULO`, `FK_IDENTIFICACION_COMPROBANTE`, `CAL_SUBTOTAL`, `CAL_SUBTOTAL_CERO`, `CAL_SUBTOTAL_NO_OBJ_IVA`, `CAL_SUBTOTAL_EXC_IVA`, `CAL_SUBTOTAL_SIN_IMPUESTOS`, `CAL_TOTAL_DESC`, `CAL_ICE`, `CAL_IVA_12`, `CAL_DEVOLUCION_IVA`, `CAL_IRBPNR`, `CAL_PROPINA`, `CAL_TOTAL`, `CAL_SIN_SUBCIDIO`, `CAL_AHORRO_SUBCIDIO`) VALUES
(1, 1, '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400', '10.400');
...
(2, 'RAÚL RICARDO ', 'PÉREZ MENDOZA ', '0912723061', '0912723061', 'raul@gmail.com', '0980868421', 'MILAGRO ', '2022-09-04', '2022-09-29', 'ANTHONYX', '', 'EN LINEA'),
(3, 'JUENITO', 'PEREZ', '1234567897', '1234567899874', 'fuiedhfudhnfhndjkfhjkdhfjkdhfjkdhjfdh@fheuifhejkhfjehfjkef.com', '0987347804', 'TRES PAJARITOS EN UN VALCON... EL DE MEDIO MARIC-.-...., A.V ROCA FUERTE Y TRANSERVAKLES A LA DIRRECIION INDICADA AMNTEWRIORM,EMTWEFVB ', '1999-05-03', '2022-10-14', 'ANTHONYX', '186.47.180.224', 'EN LINEA'),
(4, 'VGHBBHBJHHJB', 'ASDFGHJ', '1234567890', '1234567890123', 'ASDFGFHJKLIUYTRED@KUJYHTGFRHJKasdfghjkl.com', '1234567890', 'SDFGHJKLQWERTYUIOP´{ÑLKJHGFDSAZXCVBNM,.{ÑLKJHGFDSA', '1995-05-05', '2022-10-14', 'ANTHONYX', '186.47.180.224', 'EN LINEA');
...
--
-- Volcado de datos para la tabla `datos_emisor`
--

INSERT INTO `datos_emisor` (`ID_EMPRESA`, `EMP_RUC`, `EMP_NOMBRE_COMERCIAL`, `EMP_RAZON_SOCIAL`, `EMP_CONTRIBUYENTE_ESP`, `EMP_MATRIZ`, `FK_SUCURSAL`) VALUES
(2, 1721631413, 'DESARROLLO_OSCAR', 'DESARROLLO_OSCAR', 'DESARROLLO_OSCA', 'CAYAMBE', 2);
...
CREATE TABLE `detalle_factura` (
  ...
  `FK_COMPROBANTE` int(11) NOT NULL,
...
INSERT INTO `detalle_factura` (`ID_DETALLE`, `FK_COMPROBANTE`, `DET_COD_PRINCIPAL`, `DET_COD_AUX`, `DET_DESCRIPCION`, `DET_ADICIONAL`, `DET_PRECIO_UNITARIO`, `DET_PRECIO_TOTAL`) VALUES
(1, 1, 'A11', 'A12', 'FACTURA1', 1212121212, '50.000', '100.000');
...
(9, 1, 'ZAFIRO', 'PETROVIK', '1234567890', 'asdfghjklñqwertyuiop@qwertyuiop.com', '1234567890', '0-L5NY3A7KYSRK5Q6FRN9LRW', '2221-08-09', '2022-10-14', 'ANTHONYX', '186.47.180.224', 'EN LINEA', '1yFOLjrlNlUX934d4NWsl2ietfTUGITJA');
...
--
-- Estructura de tabla para la tabla `identificacion_comprobante`
--

CREATE TABLE `identificacion_comprobante` (
  `ID_COMPROBANTE` int(11) NOT NULL,
  `FK_CLIENTE` int(11) NOT NULL,
  `CON_NUMERO` varchar(50) NOT NULL,
  `CON_FECHA_EMISION` date NOT NULL,
  `CON_CLAVE_ACCESO` varchar(50) NOT NULL,
  `CON_GUIA_EMISION` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `identificacion_comprobante`
--

INSERT INTO `identificacion_comprobante` (`ID_COMPROBANTE`, `FK_CLIENTE`, `CON_NUMERO`, `CON_FECHA_EMISION`, `CON_CLAVE_ACCESO`, `CON_GUIA_EMISION`) VALUES
(1, 1, 'DESARROLLO OSCAR', '2022-10-14', 'OSCAR123', 'OSCAR123'),
(2, 1, 'DESAROOLLO', '2022-10-15', 'OSCAR123', 'OSCAR123');
...
CREATE TABLE `producto` (
  ...
  `PRO_CODIGO_AUX` varchar(15) NOT NULL,
  ...
  `PRO_USO_EXTRA` varchar(55) NOT NULL,
...
INSERT INTO `producto` (`ID_PRODUCTO`, `FK_SUCURSAL`, `FK_PROVEEDOR`, `FK_CATEGORIA`, `PRO_NOMBRE`, `PRO_CODIGO`, `PRO_CODIGO_AUX`, `PRO_STOCK`, `PRO_VALOR_FABRICA`, `PRO_VALOR_UNITARIO`, `PRO_GANANCIA`, `PRO_IVA_TIPO`, `PRO_USO`, `PRO_USO_EXTRA`, `PRO_IMG1`, `PRO_IMG2`, `PRO_IMG3`, `PRO_IMG4`, `PRO_CREACION`, `PRO_CREADOR`, `PRO_IP`, `PRO_ESTADO`) VALUES
(1, 1, 1, 1, 'Chocolate blanco', '1ad2s5a2a5a2a', '1ad2s5a2a5a2a', 50, 50.000, '0.500', 0, 'SIN IVA', 'Para endulzar tus dias con un rico sabor y olor que te va a enamorar.', 'USO EXTRA', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '2022-10-08', 'RICHARD PEREZ', '123.123.123.112', 'EN LINEA'),
(2, 1, 2, 1, 'Galletas Oreo', 'gltas-oreo1a', '1ad2s5a2a5a2a', 100, 50.000, '1.550', 5, 'CON', 'Aportan vitalidad, saciedad, y son ricas en nutrientes. Picoteo saludable, para aquellos momentos de toma energética o placer.', 'USO EXTRA', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '2022-10-08', 'RICHARD PEREZ', '123.123.123.112', 'EN LINEA'),
(3, 1, 3, 1, 'proNombre', '1a2s3d4f5g6h', '1ad2s5a2a5a2a', 100, 100.000, '50.000', 4, 'Con iva', 'Aportan vitalidad, saciedad, y son ricas en nutrientes. Picoteo saludable, para aquellos momentos de toma energética o placer.', 'USO EXTRA', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '2022-10-09', 'admin', '200.125.229.67', 'EN LINEA'),
(4, 1, 2, 1, 'proNombre01', '1a2s3d4f5g6h', '1ad2s5a2a5a2a', 100, 100.000, '10.000', 10, 'Con iva', 'proUso1111111111111111111', 'USO EXTRA', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '2022-10-09', 'RAUL PÉREZ ', '200.125.229.67', 'EN LINEA'),
(5, 1, 3, 1, 'producto nombre 02', 'a1s2d3f4g5h6j', '1ad2s5a2a5a2a', 100, 110.000, '110.000', 10, 'Con iva', 'detalle producto 02', 'USO EXTRA', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '2022-10-10', 'RAUL PÉREZ ', '200.107.21.5', 'EN LINEA'),
(6, 1, 1, 1, 'producto 06', 'asdad', '1ad2s5a2a5a2a', 100, 100.000, '120.000', 20, 'Con iva', 'detalle producto 06', 'USO EXTRA', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '1shxBcs_-DngP178Q7X3OlQo_dPozb2Zq', '2022-10-10', 'RAUL PÉREZ ', '200.107.21.5', 'EN LINEA');
...
--
-- Indices de la tabla `identificacion_comprobante`
--
ALTER TABLE `identificacion_comprobante`
...
--
-- AUTO_INCREMENT de la tabla `identificacion_comprobante`
--
ALTER TABLE `identificacion_comprobante`
