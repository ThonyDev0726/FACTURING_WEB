...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2022 a las 07:39:47
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERT_PRODUCTO` (IN `FK_SUCURSAL_V` INT, IN `FK_PROVEEDOR_V` INT, IN `FK_CATEGORIA_V` INT, IN `PRO_NOMBRE_V` VARCHAR(155), IN `PRO_CODIGO_V` VARCHAR(55), IN `PRO_CODIGO_AUX_V` VARCHAR(55), IN `PRO_STOCK_V` INT, IN `PRO_VALOR_FABRICA_V` DECIMAL(10,3), IN `PRO_VALOR_UNITARIO_V` DECIMAL(10,3), IN `PRO_GANANCIA_V` INT, IN `PRO_IVA_TIPO_V` VARCHAR(15), IN `PRO_USO_V` VARCHAR(255), IN `PRO_USO_EXTRA_V` VARCHAR(55), IN `PRO_IMG1_V` VARCHAR(255), IN `PRO_IMG2_V` VARCHAR(255), IN `PRO_IMG3_V` VARCHAR(255), IN `PRO_IMG4_V` VARCHAR(255), IN `PRO_CREACION_V` DATE, IN `PRO_CREADOR_V` VARCHAR(155), IN `PRO_IP_V` VARCHAR(15), IN `PRO_ESTADO_V` VARCHAR(15))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_CLIENTE` (IN `ID_CLIENTE_V` INT, IN `CLI_NOMBRES_V` VARCHAR(155), IN `CLI_APELLIDOS_V` VARCHAR(155), IN `CLI_CEDULA_V` VARCHAR(15), IN `CLI_RUC_V` VARCHAR(15), IN `CLI_EMAIL_V` VARCHAR(155), IN `CLI_TELEFONO_V` VARCHAR(15), IN `CLI_DIRECCION_V` VARCHAR(255), IN `CLI_CUMPLEANOS_V` DATE, IN `CLI_ESTADO_V` VARCHAR(15))   BEGIN
UPDATE CLIENTE SET 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_PRODUCTO` (IN `ID_PRODUCTO_V` INT, IN `FK_SUCURSAL_V` INT, IN `FK_PROVEEDOR_V` INT, IN `FK_CATEGORIA_V` INT, IN `PRO_NOMBRE_V` VARCHAR(155), IN `PRO_CODIGO_V` VARCHAR(55), IN `PRO_CODIGO_AUX_V` VARCHAR(55), IN `PRO_STOCK_V` INT, IN `PRO_VALOR_FABRICA_V` DECIMAL(10,3), IN `PRO_VALOR_UNITARIO_V` DECIMAL(10,3), IN `PRO_GANANCIA_V` INT, IN `PRO_IVA_TIPO_V` VARCHAR(15), IN `PRO_USO_V` VARCHAR(255), IN `PRO_USO_EXTRA_V` VARCHAR(255), IN `PRO_IMG1_V` VARCHAR(255), IN `PRO_IMG2_V` VARCHAR(255), IN `PRO_IMG3_V` VARCHAR(255), IN `PRO_IMG4_V` VARCHAR(255), IN `PRO_ESTADO_V` VARCHAR(15))   BEGIN
    UPDATE PRODUCTO SET
        FK_SUCURSAL = FK_SUCURSAL_V,
        FK_PROVEEDOR = FK_PROVEEDOR_V,
        FK_CATEGORIA = FK_CATEGORIA_V, 
        PRO_NOMBRE = PRO_NOMBRE_V, 
        PRO_CODIGO = PRO_CODIGO_V, 
        PRO_CODIGO_AUX = PRO_CODIGO_AUX_V, 
        PRO_STOCK = PRO_STOCK_V, 
        PRO_VALOR_FABRICA = PRO_VALOR_FABRICA_V, 
        PRO_VALOR_UNITARIO = PRO_VALOR_UNITARIO_V, 
        PRO_GANANCIA = PRO_GANANCIA_V, 
        PRO_IVA_TIPO = PRO_IVA_TIPO_V, 
        PRO_USO = PRO_USO_V, 
        PRO_USO_EXTRA = PRO_USO_EXTRA_V, 
        PRO_IMG1 = PRO_IMG1_V, 
        PRO_IMG2 = PRO_IMG2_V, 
        PRO_IMG3 = PRO_IMG3_V, 
        PRO_IMG4 = PRO_IMG4_V, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `UPDATE_PRODUCTO_ESTADO` (IN `ID_PRODUCTO_V` INT, IN `PRO_ESTADO_V` VARCHAR(15))   BEGIN
UPDATE PRODUCTO SET 
    PRO_ESTADO = PRO_ESTADO_V
    WHERE ID_PRODUCTO = ID_PRODUCTO_V;
END$$
...
(3, 'JUANITO', 'PEREZ', '1234567897', '1234567899874', 'juanito@gmail.com', '0987347804', 'DIRECCION DEL CLIENTE', '1999-05-03', '2022-10-14', 'ANTHONYX', '186.47.180.224', 'EN LINEA'),
(4, 'VGHBBHBJHHJB', 'ASDFGHJ', '1234567890', '1234567890123', 'correo@correo.com', '1234567890', 'DIRECCION DEL CLIENTE', '1995-05-05', '2022-10-14', 'ANTHONYX', '186.47.180.224', 'EN LINEA');
...
(7, 1, 3, 1, 'producto nuevo', 'asdadad', 'asdaddaad11', 100, 50.000, '55.000', 10, 'Con iva', 'uso producto', 'sabor picante', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '1NWr-jjRs6asWYn1iHDFTXT-a5f6QqQAT', '2022-10-15', 'RICHARD PÉREZ ', '200.125.228.0', 'EN LINEA');
