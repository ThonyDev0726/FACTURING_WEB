...
"use strict"
        ...
        alert("¡Lo siento! La superposición no es posible en el diseño Horizontal.");
                return;
        }
        }
        ...
        alert("¡Lo siento! El menú completo no está disponible en el diseño de caja vertical.");
                return;
        }

        if (this.value === "modern" && body.attr('data-sidebar-position') === "fixed") {
        alert("¡Lo siento! El diseño moderno de la barra lateral no está disponible en la posición fija. Cambie la posición de la barra lateral a Estática.");
                return;
        }
        }
